        ...
        return (
            <div className='content'>
                <div style={{ minHeight: '100vh', background: 'rgba(0,0,0,.5)' }}>
                    {/* bs5-navbar-background => chỉnh màu */}
                    <nav className="navbar navbar-expand-sm navbar-dark" style={{ background: 'rgba(110,203,200,0.9)' }}>
                                ...
                                return <div className='col-md-3 col-lg-2 mt-2' key={index}>
                                    <div className='card'>
                                        ...
                                        <div className='card-body bg-dark text-white'>
                                            <h2 style={{height:75,fontSize:20}}>{prod.tenPhim}</h2>
